...
class InstallerWindow:
    ...
    def i18n(self):
        ...
        self.wizard_pages[self.PAGE_TYPE] = WizardPage(_("Installation Type"), "drive-harddisk-system-symbolic", _("Where do you want to install Bodhi Linux?"))
        self.wizard_pages[self.PAGE_PARTITIONS] = WizardPage(_("Partitioning"), "drive-harddisk-system-symbolic", _("Where do you want to install Bodhi Linux?"))
        ...
        # Welcome page
        self.builder.get_object("label_welcome1").set_text(_("Welcome to the Bodhi Linux Installer."))
        self.builder.get_object("label_welcome2").set_text(_("This program will ask you some questions and set up Bodhi Linux on your computer."))
        ...
        self.builder.get_object("label_automated2").set_text(_("Erase a disk and install Bodhi Linux on it."))
        ...
        self.builder.get_object("label_manual2").set_text(_("Manually create, resize or choose partitions for Bodhi Linux."))
    ...
    def _generate_keyboard_layout_preview(self, *args, **kwargs):
        ...
        os.system("python3 /usr/lib/live-installer/frontend/generate_keyboard_layout.py %s %s %s %s" % (layout, variant, filename, hidpi))
