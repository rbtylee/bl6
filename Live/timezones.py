...
def debug(func):
    ...
    def wrapper(*func_args, **func_kwargs):
        # print('func_code.co_varnames =', func.__code__.co_varnames)
        # print('func_code.co_argcount =', func.__code__.co_argcount)
        # print('func_args =', func_args)
        # print('func_kwargs =', func_kwargs)
        params = []
        for argNo in range(func.__code__.co_argcount):
            argName = func.__code__.co_varnames[argNo]
            argValue = func_args[argNo] if argNo < len(func_args) else func.func_defaults[argNo - func.__code__.co_argcount]
